...
public interface VoteRepository extends JpaRepository<Vote, UUID>{
	...
	@Query(value = "SELECT * FROM vote WHERE voter_id =:voter_id AND post_id=:post_id", nativeQuery = true)
	...
	@Query(value = "SELECT * FROM vote WHERE post_id =:post_id AND vote=true", nativeQuery = true)
