...
public class SwaggerConfig {
	...
	private final String DESCRIPTION = "Microblog Api documentation";
	private final String VERSION = "1.0.1";

	@Bean
	public Docket swaggerSpringfoxDocket() {

		Contact contact = new Contact("Microblog", "", "mazhar.shapnil@gmail.com");

		ApiInfo apiInfo = new ApiInfo("Microblog", DESCRIPTION, VERSION, "", contact, "", "", new ArrayList<>());
